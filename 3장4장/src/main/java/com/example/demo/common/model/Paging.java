...
public class Paging {
    ...
    * @param pageNo
    */
    public Paging(String uri, String searchParameters, long totalCount, long pageNo) {
        this.uri = uri;
     ...
     * @param pageRows
     */
    public Paging(long totalCount, long pageNo, long pageRows) {
        this.totalCount = totalCount;
        this.pageNo = pageNo;
     ...
     * @param pageRows
     */
    public Paging(long totalCount, long pageNo, long pageRows, long pageListCount) {
        this.totalCount = totalCount;
        this.pageNo = pageNo;
        this.pageRows = pageRows;
    ...
    * @param pageRows
    */
    public Paging(String uri, String searchParameters, long totalCount, long pageNo, long pageRows) {
        this.uri = uri;
        this.searchParameters = searchParameters;
        this.totalCount = totalCount;
        this.pageNo = pageNo;
    ...
    * @param pageListCount
    */
    public Paging(String uri, String searchParameters, long totalCount, long pageNo, long pageRows, long pageListCount) {
        this.uri = uri;
        this.searchParameters = searchParameters;
        this.totalCount = totalCount;
        this.pageNo = pageNo;
